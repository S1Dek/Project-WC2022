...
<body>
	...
	$connect= @new mysqli($db_domain,$db_login,$db_password,$db_name);	//połączenie do bazy
		...
		if($result1=@$connect->query($sql_hint)){	//wysłanie zapytania do bazy
		...
		?>	
			...
			<div id="matchcontainer" style="background:<?php echo $URLstadium?>" >
				...
				<div id=host_matchcontainer_goal>".$country1_goals."</div><div id=odd><div id=odd_h> <p>1</p> <p>X</p> <p>2</p></div>
				<div id=odd_d> <p>$odd_1</p> <p>$odd_X</p> <p>$odd_2</p></div>
				</div><div id=guest_matchcontainer_goal>".$country2_goals."</div>" ?>
